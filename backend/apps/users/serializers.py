...
class GoogleAccountSerializer(serializers.ModelSerializer):
    """Read-only serializer for linked Google account info."""

    class Meta:
        model = GoogleAccount
        fields = ["google_email", "google_picture", "created_at"]
...
class UserSerializer(serializers.ModelSerializer):
    ...
    google_account = GoogleAccountSerializer(read_only=True)
...
class GoogleConnectSerializer(serializers.Serializer):
    """Serializer for connecting Google account to user profile."""
